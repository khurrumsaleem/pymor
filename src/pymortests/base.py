...
from pymor.core.exceptions import DependencyMissing, NoTestResultDataFound
...
def check_results(test_name, params, results, *args):
    ...
    try:
        ...
        raise NoTestResultDataFound(msg=f'No results found for test {test_name} ({params}), saved current results.'
